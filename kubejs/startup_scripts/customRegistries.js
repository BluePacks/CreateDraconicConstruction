...
onEvent("item.registry", (event) => {
    event.create("osmium_drill").displayName("Osmium Drill");

    event.create("silicon_wafer").displayName("Silicon Wafer");

    event
        .create("incomplete_silicon_wafer")
        .displayName("Incomplete Silicon Wafer");

    event.create("crushed_tuff").displayName("Crushed Tuff");

    event
        .create("brass_plated_cast_iron")
        .displayName("Brass Plated Cast Iron");

    event.create("unrefined_metal_scrap").displayName("Unrefined Metal Scrap");
    ...
    event
        .create("crystal_collector", "pickaxe")
...
onEvent("item.registry.tool_tiers", (event) => {
    event.add("crystal", (tier) => {
        //custom tier for flint items
        tier.uses = 1024;
        tier.speed = 3;
...
onEvent("block.registry", (event) => {
    ...
    event
        .create("advanced_mekanikal_matrix")
    ...
    event
        .create("smart_rotational_matrix")
    ...
    event
        .create("smart_rotational_matrix_part")
...
onEvent("mekanism.infuse_type.registry", (event) => {
    event.create("osmium_infuse").displayName("Osmium");
});
...
onEvent("worldgen.add", (event) => {
    ...
    event.addOre((ore) => {
        ...
        ore.addTarget(
            ...
            "kubejs:deepslate_chromium_ore"
        ); // replace anything in the vanilla stone_ore_replaceables tag with Glowstone
