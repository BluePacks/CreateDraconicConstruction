onEvent("recipes", (event) => {
    function castingTableRecipe(outputItem, inputFluid, fluidAmount, castType) {
        event.recipes.tconstruct
            .casting_table(outputItem, inputFluid, fluidAmount)
    ...
    event.recipes.tconstruct.casting_basin(
        ...
        "kubejs:molten_quartz_enriched_iron",
        810
    );
    event.recipes.tconstruct
        .casting_basin(
            "kubejs:budding_rose_quartz",
            "kubejs:molten_rose_quartz",
            1200
        )
        .cast("#cdc:budding_blocks")
        .consumeCast()
        .coolingTime(600);
    ...
    castingTableRecipe(
        "kubejs:recycled_metal_gear",
        "kubejs:molten_mekanikal_parts",
        360,
        "gear"
    );
    castingTableRecipe(
        "kubejs:recycled_metal_rod",
        "kubejs:molten_mekanikal_parts",
        45,
        "rod"
    );
    castingTableRecipe(
        "kubejs:recycled_metal_plate",
        "kubejs:molten_mekanikal_parts",
        90,
        "plate"
    );
