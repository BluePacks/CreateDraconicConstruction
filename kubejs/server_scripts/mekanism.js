onEvent("recipes", (event) => {
    ...
    event.recipes.createCrushing(
        [
            "kubejs:raw_chromium",
            Item.of("kubejs:raw_chromium").withChance(0.75),
        ],
        "kubejs:chromium_ore"
    );
    event.recipes.createCrushing(
        [
            "2x kubejs:raw_chromium",
            Item.of("kubejs:raw_chromium").withChance(0.75),
        ],
        "kubejs:deepslate_chromium_ore"
    );
    event.shapeless("kubejs:copper_alloy_wire", [
        "thermal:cured_rubber",
        "2x #forge:ingots/copper",
        "kubejs:recycled_metal_wire",
    ]);
    event.recipes.createCompacting(Fluid.of("kubejs:machine_lubricant", 250), [
        Fluid.of("thermal:crude_oil", 1000),
        "2x #forge:crops",
    ]);
    event.recipes.createMixing(Fluid.of("kubejs:molten_mekanikal_parts", 3), [
        Fluid.of("kubejs:refined_metal_scrap", 1),
        Fluid.of("tconstruct:molten_osmium", 2),
    ]);
    event.shapeless("mekanism:steel_casing", [
        "2x kubejs:smart_rotational_matrix",
    ...
    event.shaped("kubejs:installer_base", ["RCR", "IMI", "RCR"], {
        R: "minecraft:redstone",
        C: "mekanism:basic_control_circuit",
        I: "#forge:ingots/iron",
        M: "kubejs:mekanikal_matrix",
    });
    event.recipes.createMixing("mekanism:basic_tier_installer", [
        "kubejs:installer_base",
        "mekanism:basic_control_circuit",
    ]);
    event.recipes
        .createMixing("mekanism:advanced_tier_installer", [
            "mekanism:basic_tier_installer",
            "mekanism:advanced_control_circuit",
        ])
        .heated();
    event.recipes
        .createMixing("mekanism:elite_tier_installer", [
            "mekanism:advanced_tier_installer",
            "mekanism:elite_control_circuit",
        ])
        .heated();
    event.recipes
        .createMixing("mekanism:ultimate_tier_installer", [
