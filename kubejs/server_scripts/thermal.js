onEvent("recipes", (event) => {
    ...
    event.shaped("thermal:fluid_cell", ["RGR", "ITI", "RSR"], {
    ...
    event.recipes.createCrushing(
        [
            ...
            Item.of("minecraft:diamond").withChance(0.012),
        ],
        "thermal:apatite"
    );
    ...
    event.recipes
        .createMixing(Fluid.of("thermal:redstone", 100), ["minecraft:redstone"])
        .heated();
    event.recipes
        .createMixing(Fluid.of("thermal:redstone", 900), [
