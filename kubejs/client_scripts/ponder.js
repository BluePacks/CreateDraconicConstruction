...
onEvent("ponder.tag", event => {
     ...
     * [...items]               -> default items
     */
    event.createTag("kubejs:getting_started", "kubejs:rotational_matrix", "Welcome to the pack", "Here we gooo!", [
        // some default items
...
onEvent("ponder.registry", event => {
     ...
     */
    event.create("kubejs:rotational_matrix").scene("ch1", "First example scene for chapter 1", "kubejs:rotation",(scene, util) => {
        const cowLink = scene.world.createEntity("cow", [2.5, 1, 2.5]);
        scene.showControls(60, [2.5,3,2.5], "down").withItem("mekanism:configurator").rightClick()
        scene.showBasePlate()
